...
The next [Bayesian memory comparison](research/otto-residual-estimator-engineering.md)
passes 278 implementation tests; its fresh-data experiment has not run yet.
