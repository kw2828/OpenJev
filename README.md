...
- [Robot reaching with missing sensors](research/reacher-world-model-pilot.md): nine learned world models, recorded replay and all weights. Neither recurrent model improved over zero commands.
