...
[![All nine token-alignment fits: changed-value gains, retained-value harms, compute costs and failed continuation rule](output/dialogue-token-alignment-scientific-v1/figure-01/alignment.png)](research/dialogue-token-alignment-scientific-results.md)
