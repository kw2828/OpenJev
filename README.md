...
- [Plan-memory comparison](research/reacher-proposal-memory.md): nine runs passed replay, but carrying the previous plan forward passed only 2/6 performance checks. The [earlier dynamics-adaptation test](research/reacher-tracking-engineering.md) also showed little benefit; a learned adaptation study is not yet justified.
