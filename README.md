...
The [encoder-learning pilot](research/dialogue-finetune-qualification-results.md) now passes real gradient and state-validity checks across six comparisons in **8.15 seconds**. This qualifies the training path; it uses synthetic targets and reports no accuracy gain.
