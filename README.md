...
- [Planning diagnostic](research/reacher-common-root-diagnostic.md): a longer horizon lowered mean branch cost by 7.33%, but missed the consistency rule; accurate dynamics gained 2.51%. All three comparisons failed, so this tracking setup is closed. [Earlier plan-memory test](research/reacher-proposal-memory.md).
