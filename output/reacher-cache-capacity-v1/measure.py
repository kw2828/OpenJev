...
try:
    ...
    namespace = "reacher-cache-engineering-capacity-v1"
    ...
    cfg = training.CacheTrainingSettings()
    ...
    paths = ["src/openjev/research/reacher_cache_training.py", "src/openjev/research/reacher_cache_control.py",
             "src/openjev/research/reacher_cache_protocol.py", "src/openjev/research/reacher_cached_observation.py",
