import hashlib,json,os,subprocess,time,traceback,importlib.metadata,platform,sys
...
def checks():
 assert {"python":platform.python_version(),"executable":sys.executable,"versions":{n:importlib.metadata.version(n) for n in cfg["runtime"]["versions"]}}==cfg["runtime"],"runtime drift"
