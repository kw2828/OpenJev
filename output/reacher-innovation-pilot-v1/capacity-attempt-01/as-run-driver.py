...
OUT = Path("output/reacher-innovation-pilot-v1/capacity-attempt-01")
...
def main():
    ...
    runtime = {"torch": torch.__version__, "platform": platform.platform(), "dtype": "float32", "torch_threads": 1}
