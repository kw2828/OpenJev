...
OUT = ROOT / 'output/otto-return-consistency-v1'
...
plan = {
    ...
    'output': 'output/otto-return-consistency-v1/run-01',
...
with (OUT / 'plan-01.json').open('x') as stream:
    ...
    stream.write('\n')
print(json.dumps(identity('output/otto-return-consistency-v1/plan-01.json')))
