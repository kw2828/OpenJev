...
elapsed=time.monotonic()-start;rss=resource.getrusage(resource.RUSAGE_CHILDREN).ru_maxrss*(1 if sys.platform=='darwin' else1024)
...
raise SystemExit(0 if ok else1)
