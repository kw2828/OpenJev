...
def prepare(args):
    ...
    try:
        ...
        require(freeze["status"] == "frozen_before_collection" and freeze["capacity_admitted"] is True
            and freeze["no_retry_or_replacement_seeds"] is True and freeze["requires_original_supervisors"] is True
