"""One execution and saved-output audit of the already frozen explicit-cache study."""
...
PLAN = ROOT / 'evidence/reacher-cache-ablation-v1/protocol/plan.json'
DIGEST = '7868daa12242df37f020946f9d3b279811a0e97547eef4d8b179da6e9394cefa'
OUT = ROOT / 'output/reacher-cache-ablation-v1/supervision'
EXECUTION = ROOT / 'runs/reacher-cache-ablation-v1/attempt'
AUDIT = ROOT / 'evidence/reacher-cache-ablation-v1/audit'
...
def main():
    ...
    try:
        ...
        with (OUT/'execution.log').open('x') as log:
            subprocess.run([sys.executable, '-u', 'scripts/reacher_cache_study.py', 'run',
        ...
        with (OUT/'audit.log').open('x') as log:
            subprocess.run([sys.executable, '-u', 'scripts/audit_reacher_cache_study.py',
