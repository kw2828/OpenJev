...
env = {**os.environ, **dict.fromkeys(keys, '1'), 'PYTHONDONTWRITEBYTECODE': '1', 'PYTEST_DISABLE_PLUGIN_AUTOLOAD': '1', 'PYTEST_ADDOPTS': '', 'PYTEST_PLUGINS': ''}
...
preflight = {'sources': before, 'snapshots': {n: pin(out/'source'/n) for n in sources},
             'commands': commands, 'environment': {k: env[k] for k in (*keys, 'PYTHONDONTWRITEBYTECODE', 'PYTEST_DISABLE_PLUGIN_AUTOLOAD', 'PYTEST_ADDOPTS', 'PYTEST_PLUGINS')},
