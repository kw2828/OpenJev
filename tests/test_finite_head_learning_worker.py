...
W = load('finite_head_learning_worker')
P = load('qualify_finite_head_exposure')
...
def test_qualification_selects_new_probe_and_tests():
    ...
    assert commands[2] == ['/fixture/python', str(ROOT / 'scripts/qualify_finite_head_exposure.py'),
