...
SPEC = importlib.util.spec_from_file_location("residual_runner_tests", Path(__file__).parents[1] / "scripts/run_otto_residual.py")
...
@pytest.mark.parametrize("defect", ("wrong_phase", "wrong_configuration", "lineage_changed", "pending", "pending_io",
    ...
    "wrong_plan_pin", "parent_failed", "reversed_collection_chronology"))
