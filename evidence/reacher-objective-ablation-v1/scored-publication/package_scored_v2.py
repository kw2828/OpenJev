...
out=root/'output/reacher-objective-ablation-v1/scored-publication-v2'
...
assert set(c['files'])=={str(x.relative_to(ex)) for x in ex.rglob('*') if x.is_file() and x!=ex/'completed.json'}
