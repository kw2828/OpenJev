...
The local study fits all 18 adapters and evaluates all 21 models, including three unchanged backbones. Read the [design, continuation rule and reproduction commands](../../research/chess-connectome-study.md). Results are pending.
