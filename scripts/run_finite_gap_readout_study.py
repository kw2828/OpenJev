"""Nine frozen parents, gap-certified TRAIN heads, then a new DEV pool.

Explicit source fork of run_finite_convex_readout. The old attempt remains
closed. Only the separately qualified solver and prospective study identity
change; all state extraction, readout mapping and no-DEV-before-solves guards
are preserved. No recurrent weights are updated.
"""
...
from openjev.research.finite_convex_readout import build_problem
...
from openjev.research.finite_gap_readout import solve
