"""Reuse the qualified opaque-byte packager for the exact-cache diagnostic."""
...
def main():
    ...
    spec = importlib.util.spec_from_file_location("_exact_cache_packager", PACKAGER)
    module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(module)
    module.VERSION = "otto-exact-cache-package-v1"
    module.NAME = "openjev-otto-exact-cache-v1.tar.gz"
    module.execute(args)
