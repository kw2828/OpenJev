...
def main():
    ...
    try:
        ...
        require(plan['version'] == 'finite-convex-readout-v1', 'registered study version')
        ...
        if args.phase == 'qualify':
            ...
            from run_finite_convex_readout import run
            ...
            output.mkdir()
            from audit_finite_convex_readout import audit
