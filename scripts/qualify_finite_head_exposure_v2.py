...
from finite_head_learning_worker_v2 import descriptor, files, publish, require
from register_finite_head_learning_v2 import EXPOSURE
...
def main():
    ...
    record = {'version': 'finite-head-exposure-v1', 'status': 'FAILED', **EXPOSURE,
    ...
    try:
        ...
        verified = audit(output / 'run', check=check, profile='engineering-946201')
