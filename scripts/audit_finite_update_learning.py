"""Independent saved-output audit for exact-update rounded-transport learning.
...
VERSION = 'finite-update-learning-audit-v1'
NAMESPACE = 433260924
ARMS = ('original_free', 'matched_free', 'rounded')
SEEDS = (433261001, 433261002, 433261003)
HORIZONS = (1, 2, 4, 8)
...
SCIENCE = StudyProfile('science', NAMESPACE, SEEDS, 512, 128, 64, 1024, 3072, 120.)
EngineeringSpec = StudyProfile
PROFILES = MappingProxyType({'science': SCIENCE,
    'engineering-942001': StudyProfile('engineering-942001', 942001, (942101,), 8, 8, 3, 3, 4, 30.),
    'engineering-942201': StudyProfile('engineering-942201', 942201, (942301,), 512, 8, 64, 32, 64, 30.)})
...
def validate_metadata(folder, summary, *, check=lambda: None, spec=SCIENCE):
    ...
    require(summary['version'] == 'finite-update-learning-v1', 'registered allocation producer')
