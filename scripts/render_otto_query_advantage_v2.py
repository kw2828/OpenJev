...
VERSION = "otto-query-advantage-render-v2"
PLAN_PIN = "a3606093ef0fe7b01d3e2cb4b51619f043e0b336cded977e815fcbcf2a05e8d7"
AUDITOR = "scripts/audit_otto_query_advantage_v2.py"
AUDITOR_PIN = "638656e2bd4283af27fbe734837f79e5d7feaaf6a9e3ad271ea4cfabf6804bce"
PRODUCER = "scripts/study_otto_query_advantage_v2.py"
PRODUCER_PIN = "a8a51a5124ca2d7155b8dc339123b63ee54c66b6581c1c13e70a6e38bd6e76ca"
...
class Render:
    ...
    def parent(self, receipt, terminal, directory, script, cap, options):
        ...
        require(script != PRODUCER or command[1] == str(ROOT / PRODUCER), "canonical absolute V2 producer")
    ...
    def authenticate(self):
        ...
        require(plan["version"] == worker["version"] == "otto-query-advantage-study-v2"
        ...
        require(closure["pending"] == closure["errors"] == [] and closure["poisoned"] is False
            ...
            and 0 <= closure["close_seconds"] <= worker["wall_seconds"], "durable V2 journal closure")
        require(audit["version"] == "otto-query-advantage-audit-v2" and audit["status"] == "completed"
        ...
        producer_command = self.parent(worker, terminal, a.run, PRODUCER, 900,
        ...
        same(audit["producer_process"], {"producer": PRODUCER, "canonical_command": producer_command,
            "cap_seconds": 900, "journal_close_seconds": closure["close_seconds"],
    ...
    def data(self):
        ...
        require(result["agreement"] is True and result["version"] == "otto-query-advantage-audit-v2", "closed audit result")
        summary = result["summary"]
        same(original["costs"], summary["costs"])
        require(summary["journal_closure"] == self.worker["journal_closure"], "audited journal closure identity")
        same(summary["worker_seconds"], self.times["pilot_worker_seconds"])
        same(summary["parent_seconds"], self.times["pilot_parent_seconds"])
    ...
    def execute(self):
        ...
        try:
            ...
            costs.append({"metric": "journal_close_seconds", "seconds": summary["journal_closure"]["close_seconds"],
                "scope": "Separate final journal closure, included in worker/parent wall; not part of earlier saved phases."})
            ...
            write(self.out / "plotted-values.json", {"anchors": anchors, "bootstrap": draws, "statistics": statistics,
                ...
                "journal_closure": summary["journal_closure"], "physical_times": self.times, "limitations": limitations,
