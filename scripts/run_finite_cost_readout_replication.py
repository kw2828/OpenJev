"""Fresh-seed replication of the frozen softened versus learned cost readout recipe."""
...
VERSION = 'finite-cost-readout-replication-v1'
...
DEFAULT_CONFIG = {'seed_namespace': 425260924, 'train_attempts': 512,
    'dev_attempts': 128, 'epochs': 480, 'batch_size': 64, 'learning_rate': .003,
    'fit_seeds': [425261001, 425261002, 425261003], 'gradient_clip': 5.,
