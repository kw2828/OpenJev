"""Factorized dynamics with matched-function and dense free controls; admitted by the worker."""
...
VERSION = 'finite-factorized-dynamics-v1'
...
DEFAULT_CONFIG = {'seed_namespace': 426260924, 'train_attempts': 512,
    'dev_attempts': 128, 'epochs': 480, 'batch_size': 64, 'learning_rate': .003,
    'fit_seeds': [426261001, 426261002, 426261003], 'gradient_clip': 5.,
...
def run(folder: Path, config: dict, check):
    ...
    counts = dict.fromkeys(('train_generation_count', 'dev_generation_count', 'model_constructions',
        ...
        'dynamics_snapshot_evaluations'), 0)
