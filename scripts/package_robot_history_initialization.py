...
def package(study, audit_path, plot, engineering, output):
    ...
    (output / 'README.md').write_text(
        ...
        'All 18 fresh attempts and 30 unchanged inherited fits are retained, including both rates and all three seeds. '
        'Initial/final checkpoints, Adam arrays, traces, paired batches, all available ordinary and reversed-history forecasts, '
        '208 ordinary rows, 36 diagnostic rows and 29 frozen source snapshots are preserved. Known temporal reversal failures '
        ...
        'Each affine initializer adds 372 parameters to the 590-parameter transition; last-two has 590.\n\n'
