...
def main():
    ...
    try:
        ...
        require(plan['version'] == 'finite-cost-readout-replication-v1', 'replication registration version')
        ...
        if args.phase == 'qualify':
            ...
            from run_finite_cost_readout_replication import run
            ...
            output.mkdir()
            from audit_finite_cost_readout_replication import audit
