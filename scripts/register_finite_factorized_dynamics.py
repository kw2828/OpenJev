...
from finite_factorized_dynamics_worker import ROOT, closed_producer, descriptor, publish, require, runtime

SOURCES = (
    'scripts/register_finite_factorized_dynamics.py',
    'scripts/finite_factorized_dynamics_worker.py',
    'scripts/run_finite_factorized_dynamics.py',
    'scripts/audit_finite_factorized_dynamics.py',
    ...
    'tests/test_finite_factorized_dynamics_models.py',
    'tests/test_finite_factorized_dynamics_audit.py',
    'tests/test_finite_factorized_dynamics_worker.py',
    'tests/test_finite_factorized_dynamics_runner.py',
    'research/finite-factorized-dynamics-protocol.md',
    'pyproject.toml',
    'uv.lock',
)
...
CONFIG = {'seed_namespace': 426260924, 'train_attempts': 512, 'dev_attempts': 128,
          ...
          'fit_seeds': [426261001, 426261002, 426261003],
...
def main():
    ...
    folder = ROOT / 'output/finite-factorized-dynamics-v1'
    ...
    plan = {'version': 'finite-factorized-dynamics-v1', 'mode': args.mode,
