"""Frozen four-control candidate chess study with matched labels and updates.
...
PROTOCOL = {
    "version": "chess-candidate-v1", "arms": list(ARMS), "width": 32,
    ...
    "selection": "All final fits, no best epoch/seed, retries, replacement games or budget extension.",
