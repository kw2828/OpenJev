"""Independent saved-output audit for per-call-reuse exact-update learning.
...
VERSION = 'finite-reuse-learning-audit-v1'
NAMESPACE = 434260924
...
PROFILES = MappingProxyType({'science': SCIENCE,
    'engineering-944001': StudyProfile('engineering-944001', 944001, (944101,), 8, 8, 3, 3, 4, 30.),
    'engineering-944201': StudyProfile('engineering-944201', 944201, (944301,), 512, 8, 64, 32, 64, 30.)})
...
def validate_metadata(folder, summary, *, check=lambda: None, spec=SCIENCE):
    ...
    require(summary['version'] == 'finite-reuse-learning-v1' and summary['implementation'] == 'reuse',
