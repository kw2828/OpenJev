...
from finite_reuse_learning_worker import descriptor, files, publish, require
from register_finite_reuse_learning import EXPOSURE
...
def main():
    ...
    record = {'version': 'finite-reuse-exposure-v1', 'status': 'FAILED', **EXPOSURE,
    ...
    try:
        ...
        verified = audit(output / 'run', check=check, profile='engineering-944201')
