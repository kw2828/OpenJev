...
def main():
    ...
    try:
        ...
        require(plan['version'] == 'finite-expected-count-learning-v1', 'registered study version')
        ...
        if args.phase == 'qualify':
            ...
            from run_finite_expected_count_learning import run
            ...
            output.mkdir()
            from audit_finite_expected_count_learning import audit
