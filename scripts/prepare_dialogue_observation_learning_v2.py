"""Second preparation version: use split-qualified dialogue identities; retain failed version unchanged."""
...
import prepare_dialogue_observation_learning as first
...
SOURCES = first.SOURCES + [
    "scripts/prepare_dialogue_observation_learning_v2.py", "tests/test_prepare_dialogue_observation_learning_v2.py",
    "src/openjev/research/dialogue_finetune_dataset_v2.py", "tests/test_dialogue_finetune_dataset_v2.py",
    "research/dialogue-observation-learning-preparation-correction.md"]
INPUTS.update({'output/dialogue-observation-learning-v1/preparation-01/failed.json': 'f895a9883067dd9642707fb6b59c801265f00fca13b74beae693444f3732a1e1', 'output/dialogue-observation-learning-v1/preparation-01/source-pins.json': 'f83957633a8363effde9121fb8220757045bae725511189810ccff250b5ab302'})
...
def inherited_sources(prior):
    ...
    failed_sources = read(ROOT / "output/dialogue-observation-learning-v1/preparation-01/source-pins.json")
    require(set(failed_sources) == set(sources) | set(first.SOURCES), "Complete failed-version source lineage")
    require(all(failed_sources[name] == digest for name, digest in sources.items()), "Passed qualification lineage")
    bind(failed_sources)
...
def prepare(out):
    with attempt(out) as (start, progress, check):
        ...
        from openjev.research.dialogue_finetune_dataset_v2 import (
        ...
        plan = {"study": STUDY, "preparation_version": 2, "config": CONFIG, "caps": CAPS, "runtime": qualified.runtime(),
