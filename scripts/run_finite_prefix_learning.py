"""Matched shared-filter training with optional prefix observation likelihood; admitted by the worker."""
...
from openjev.research.finite_prefix_learning import generate_attempt_split, prefix_predictions
from openjev.research.finite_prefix_learning import make_model as learned_model

VERSION = 'finite-prefix-learning-v1'
...
DEFAULT_CONFIG = {'seed_namespace': 423260924, 'train_attempts': 512,
    'dev_attempts': 128, 'epochs': 480, 'batch_size': 64, 'learning_rate': .003,
    'fit_seeds': [423261001, 423261002, 423261003], 'gradient_clip': 5.,
...
def run(folder: Path, config: dict, check):
    ...
    counts = dict.fromkeys(('train_generation_count', 'dev_generation_count', 'model_constructions',
        ...
        'zero_endpoint_batches', 'evaluation_prefix_rollouts', 'evaluation_prefix_event_views'), 0)
