...
from finite_expected_count_learning_worker import (
    ROOT,
    admit_qualification,
    closed_producer,
    descriptor,
...
from register_finite_expected_count_qualification import SOURCES as KERNEL_SOURCES

SOURCES = tuple(dict.fromkeys((*KERNEL_SOURCES,
    'scripts/register_finite_expected_count_learning.py',
    'scripts/finite_expected_count_learning_worker.py',
    'scripts/run_finite_expected_count_learning.py',
    'scripts/audit_finite_expected_count_learning.py',
    ...
    'src/openjev/research/finite_timed_prefix.py',
    'tests/test_finite_timed_prefix.py',
    'tests/test_finite_expected_count_learning_worker.py',
    'tests/test_finite_expected_count_learning_runner.py',
    'tests/test_finite_expected_count_learning_audit.py',
    'research/finite-expected-count-learning-protocol.md',
    'research/finite-expected-count-learning-requirements.txt',
)))
...
CONFIG = {'seed_namespace': 429260924, 'train_attempts': 512, 'dev_attempts': 128,
          ...
          'fit_seeds': [429261001, 429261002, 429261003],
          'gradient_clip': 5., 'train_horizon': 2, 'dev_horizon': 8, 'pretraining_seconds': 10.}
...
def main():
    ...
    folder = ROOT / 'output/finite-expected-count-learning-v1'
    ...
    plan = {'version': 'finite-expected-count-learning-v1', 'mode': args.mode,
