...
from finite_cost_readout_replication_worker import (
    ROOT,
    closed_producer,
    descriptor,
    publish,
...
SOURCES = (
    'scripts/register_finite_cost_readout_replication.py',
    'scripts/finite_cost_readout_replication_worker.py',
    'scripts/run_finite_cost_readout_replication.py',
    'scripts/audit_finite_cost_readout_replication.py',
    ...
    'tests/test_finite_cost_readout_models.py',
    'tests/test_finite_cost_readout_replication_audit.py',
    'tests/test_finite_cost_readout_replication_worker.py',
    'tests/test_finite_cost_readout_replication_runner.py',
    'research/finite-cost-readout-replication-protocol.md',
    'pyproject.toml',
    'uv.lock',
)
...
CONFIG = {'seed_namespace': 425260924, 'train_attempts': 512, 'dev_attempts': 128,
          ...
          'fit_seeds': [425261001, 425261002, 425261003],
...
def main():
    ...
    folder = ROOT / 'output/finite-cost-readout-replication-v1'
    ...
    plan = {'version': 'finite-cost-readout-replication-v1', 'mode': args.mode,
