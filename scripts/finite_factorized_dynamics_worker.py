...
def main():
    ...
    try:
        ...
        require(plan['version'] == 'finite-factorized-dynamics-v1', 'registered study version')
        ...
        if args.phase == 'qualify':
            ...
            from run_finite_factorized_dynamics import run
            ...
            output.mkdir()
            from audit_finite_factorized_dynamics import audit
