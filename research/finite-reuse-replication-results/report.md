...
[Protocol](../finite-reuse-replication-protocol.md) · [Complete saved summary](summary.json) · [Current-study evidence](evidence.tar.gz) · [Manifest](manifest.json) · [Publication receipt](receipt.json)
