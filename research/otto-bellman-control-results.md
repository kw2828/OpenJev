...
[LaTeX paper](../paper/otto-bellman-control.tex) | [Compiled PDF](../output/pdf/openjev-otto-bellman-control.pdf) | [Complete raw archive](https://github.com/kw2828/OpenJev/releases/tag/otto-bellman-control-v1) | [Proposed coverage follow-up](otto-coverage-followup-design.md)

The release preserves all 100 original evidence paths, including every checkpoint, target array, trajectory and work journal. The repository keeps the summaries and smaller records. Use the release manifest and checksums to restore the full closed run. Earlier teacher data and scalar-study inputs remain separate dependencies, as listed in the frozen plan.
