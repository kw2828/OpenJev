...
def render(output, value):
    ...
    for detail_view in (False, True):
        ...
        fig.suptitle(f"Frozen-backbone observer development: {gate['passed']} of 5 criteria pass (all 5 required) | {view}", fontsize=15)
        ...
        fig.text(.5, .009, explanation+'\nSelected circles / unselected crosses; black lines are saved selected means; failures remain labeled. '
                 ...
                 'Same robot/day and realized future torque; no independent confirmation or control claim.', ha='center', fontsize=9)
