...
def test_complete_control_frontier_and_strict_dominance(control):
    rows, costs, cfg = fixture()
    # An exact binary fraction tests a mathematical tie without three-seed
    # summation roundoff turning it into a strict inequality against one seed.
    set_error(rows, 'temporal_affine', .75); set_error(rows, control, .75)
