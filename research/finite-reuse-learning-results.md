...
![All seeds: H4/H8 blind regret and full fit time](finite-reuse-learning-results/benchmark.png)
...
[Protocol](finite-reuse-learning-protocol.md) · [Complete saved summary](finite-reuse-learning-results/summary.json) · [Current-study evidence](finite-reuse-learning-results/evidence.tar.gz) · [Manifest](finite-reuse-learning-results/manifest.json) · [Publication receipt](finite-reuse-learning-results/receipt.json)
