...
[Protocol](../finite-decision-error-protocol.md) · [Saved summary](summary.json) · [Diagnostic evidence](evidence.tar.gz) · [Manifest](manifest.json) · [Publication receipt](receipt.json) · [Failed parent study](../finite-head-learning-results.md) · [Parent evidence](../finite-head-learning-results/evidence.tar.gz)
