...
![All five seeds: H4/H8 blind regret and complete fit time](finite-head-learning-results/benchmark.png)
...
[Protocol](finite-head-learning-protocol-v2.md) · [Complete saved summary](finite-head-learning-results/summary.json) · [Current-study evidence](finite-head-learning-results/evidence.tar.gz) · [Manifest](finite-head-learning-results/manifest.json) · [Publication receipt](finite-head-learning-results/receipt.json)
