...
![Every fit and its measured cost](finite-rounded-learning-results/benchmark.png)
...
[Protocol](finite-rounded-learning-protocol.md) · [All saved numbers](finite-rounded-learning-results/summary.json) · [Original evidence receipt](finite-rounded-learning-results/receipt.json)
