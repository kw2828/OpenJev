...
21 September 2026. Source review and a candidate mechanism for work after the [running action-head pilot](otto-action-head-status.md). No reference weights have been downloaded or evaluated, and no symmetry-aware model has been fitted. Neither proposal changes the current frozen run.

## A released learned comparator

The official OTTO zoo has a matching two-dimensional lambda3/R2 model, [`zoo_model_2_3_2`](https://github.com/C0PEP0D/otto/tree/1467029f399dc5eeac8652499a9c8326ecab4575/zoo/models/zoo_model_2_3_2), pinned at `1467029f399dc5eeac8652499a9c8326ecab4575`. Official repository metadata lists an individually available **53,581,916-byte weight file** and a **147-byte configuration**. The small configuration was inspected statically, without executing it. The repository is MIT licensed.
