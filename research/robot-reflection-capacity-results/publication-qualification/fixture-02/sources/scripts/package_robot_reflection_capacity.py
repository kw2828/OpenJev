...
def publication_fixture_files():
    ...
    paths = set()
    for name, code in (('fixture-01', 1), ('fixture-02', 0)):
        folder = base / name
...
def package(study, audit_path, plot, engineering, output):
    ...
    (output / 'README.md').write_text(
        ...
        'Both publication-only fixture attempts are retained. The first had one stale caption-text assertion; '
        'the second corrected that assertion. These tests do not change the scientific results or criteria.\n\n'
