# Robot reflection capacity: complete saved results

Same previously exposed DEV2, with one pooled rate selected per family from both rates and all three seeds. Accuracy dots retain every selected seed; diamonds are mean individual RMSEs, not ensemble forecasts. Six R12 fits are new; all36 R4/dense/GRU/legacy fits and frozen references are copied without refitting. 128-step (12.8 s) offline forecasts are conditional on realized measured torque, not verified issued commands. Structured models initialize from the last two observed positions; GRU conditions on the supplied prefix. All selected-model latency probes are current-host full requests. CONFIRM and official TEST remain closed. No new storage advantage, architectural novelty, robot-safety, native speedup or official benchmark claim.

Saved outcome: **DO_NOT_ADVANCE_REFLECTION_CAPACITY**, 38/69 conditions. Accuracy 38/67; compute 0/2.
...
|---|---|---:|---:|---:|---|---:|---:|---|---|
| 21H_54M | Householder R12 (fresh) | 0.001 | 8101 | 64 | PASS | 0.559179 | 15.4584 | 13.3534, 3.90078, 12.3092, 23.3154, 19.8185, 12.3429 |  |
| 21H_54M | Householder R12 (fresh) | 0.001 | 8101 | 128 | PASS | 0.697751 | 20.0233 | 15.0354, 4.26114, 14.8079, 32.8511, 24.9817, 15.4537 |  |
| 21H_54M | Householder R12 (fresh) | 0.003 | 8101 | 64 | PASS | 0.62921 | 17.7761 | 16.018, 3.80509, 12.162, 28.6752, 22.4633, 12.2522 |  |
| 21H_54M | Householder R12 (fresh) | 0.003 | 8101 | 128 | PASS | 0.729773 | 21.4805 | 16.6651, 3.99705, 12.9364, 37.2344, 26.0444, 15.5788 |  |
| 21H_54M | Householder R12 (fresh) | 0.001 | 8102 | 64 | PASS | 0.664624 | 18.4948 | 20.377, 4.66585, 13.4475, 29.8671, 20.5157, 11.0269 |  |
| 21H_54M | Householder R12 (fresh) | 0.001 | 8102 | 128 | PASS | 0.705655 | 20.1117 | 17.6062, 4.64492, 13.7521, 33.5061, 24.3418, 13.8214 |  |
| 21H_54M | Householder R12 (fresh) | 0.003 | 8102 | 64 | PASS | 0.568078 | 16.0358 | 17.7333, 3.62259, 11.7835, 26.7037, 17.0441, 8.53499 |  |
| 21H_54M | Householder R12 (fresh) | 0.003 | 8102 | 128 | PASS | 0.640332 | 18.5771 | 15.7014, 3.96606, 12.542, 31.1554, 21.7337, 14.4251 |  |
| 21H_54M | Householder R12 (fresh) | 0.001 | 8103 | 64 | PASS | 0.563688 | 15.6242 | 14.6203, 3.67934, 12.7617, 23.8989, 19.3222, 11.4032 |  |
| 21H_54M | Householder R12 (fresh) | 0.001 | 8103 | 128 | PASS | 0.699543 | 19.975 | 15.027, 4.14055, 14.6969, 32.3169, 25.5862, 15.3623 |  |
| 21H_54M | Householder R12 (fresh) | 0.003 | 8103 | 64 | PASS | 0.591941 | 15.8915 | 13.7583, 4.7368, 12.8142, 22.7036, 21.446, 12.8032 |  |
| 21H_54M | Householder R12 (fresh) | 0.003 | 8103 | 128 | PASS | 0.642593 | 18.2902 | 12.3693, 4.68671, 13.1571, 29.8757, 23.2335, 15.0588 |  |
| 21H_54M | Householder R4 (cached) | 0.001 | 8101 | 64 | PASS | 0.588962 | 16.6121 | 12.4261, 3.57187, 13.2459, 26.7718, 21.5826, 11.4284 |  |
| 21H_54M | Householder R4 (cached) | 0.001 | 8101 | 128 | PASS | 0.756956 | 21.7203 | 15.7607, 4.24838, 16.711, 34.7494, 27.554, 17.8374 |  |
...
| 21H_54M | Householder R4 (cached) | 0.003 | 8101 | 64 | PASS | 0.570147 | 16.2517 | 12.6599, 3.37515, 13.0072, 26.2774, 20.1323, 12.167 |  |
| 21H_54M | Householder R4 (cached) | 0.003 | 8101 | 128 | PASS | 0.682588 | 20.2942 | 14.3544, 3.79227, 15.352, 34.9572, 22.7246, 16.6313 |  |
...
| 21H_54M | Householder R4 (cached) | 0.001 | 8102 | 64 | PASS | 0.568374 | 16.2956 | 11.8688, 4.24541, 12.5533, 27.0306, 19.0784, 13.4966 |  |
| 21H_54M | Householder R4 (cached) | 0.001 | 8102 | 128 | PASS | 0.654792 | 18.9014 | 13.9595, 4.2618, 14, 31.2328, 22.7943, 15.4748 |  |
...
| 21H_54M | Householder R4 (cached) | 0.003 | 8102 | 64 | PASS | 0.584045 | 16.6345 | 17.2717, 3.75253, 11.3726, 27.6697, 18.3324, 10.8079 |  |
| 21H_54M | Householder R4 (cached) | 0.003 | 8102 | 128 | PASS | 0.669856 | 19.641 | 16.2077, 3.82875, 13.1281, 33.0235, 22.7607, 16.0098 |  |
...
| 21H_54M | Householder R4 (cached) | 0.001 | 8103 | 64 | PASS | 0.550925 | 15.3462 | 9.48952, 3.61734, 13.5692, 24.5821, 20.5805, 9.89675 |  |
| 21H_54M | Householder R4 (cached) | 0.001 | 8103 | 128 | PASS | 0.67326 | 19.001 | 11.4883, 3.8757, 15.6203, 30.2731, 25.8878, 13.733 |  |
...
| 21H_54M | Householder R4 (cached) | 0.003 | 8103 | 64 | PASS | 0.55649 | 15.0347 | 13.6533, 4.007, 11.9836, 21.8724, 20.3042, 10.9325 |  |
| 21H_54M | Householder R4 (cached) | 0.003 | 8103 | 128 | PASS | 0.712273 | 19.5379 | 15.0035, 4.5089, 14.605, 26.8391, 27.9413, 18.1816 |  |
...
| 22H_10M | Householder R12 (fresh) | 0.001 | 8101 | 64 | PASS | 0.658175 | 18.7227 | 15.7233, 5.92366, 13.6627, 32.4704, 19.6399, 13.9352 |  |
| 22H_10M | Householder R12 (fresh) | 0.001 | 8101 | 128 | PASS | 0.793217 | 22.6018 | 19.3011, 6.4774, 15.9665, 36.0423, 25.1791, 21.508 |  |
| 22H_10M | Householder R12 (fresh) | 0.003 | 8101 | 64 | PASS | 0.617779 | 17.8244 | 15.3506, 5.42821, 13.246, 31.5055, 17.232, 13.2725 |  |
| 22H_10M | Householder R12 (fresh) | 0.003 | 8101 | 128 | PASS | 0.741209 | 21.5739 | 17.7514, 5.85911, 14.6104, 37.2026, 22.9239, 17.8928 |  |
| 22H_10M | Householder R12 (fresh) | 0.001 | 8102 | 64 | PASS | 0.679682 | 19.1949 | 18.8685, 5.91716, 13.5858, 32.944, 19.4644, 13.0722 |  |
| 22H_10M | Householder R12 (fresh) | 0.001 | 8102 | 128 | PASS | 0.767178 | 22.7199 | 18.2437, 6.03362, 14.4785, 40.4029, 23.0279, 18.8578 |  |
| 22H_10M | Householder R12 (fresh) | 0.003 | 8102 | 64 | PASS | 0.737504 | 20.5696 | 18.7592, 6.14213, 13.6622, 33.1644, 24.4641, 16.2474 |  |
| 22H_10M | Householder R12 (fresh) | 0.003 | 8102 | 128 | PASS | 0.787707 | 23.0299 | 19.0365, 5.87946, 14.625, 38.4845, 25.1561, 21.3896 |  |
| 22H_10M | Householder R12 (fresh) | 0.001 | 8103 | 64 | PASS | 0.709247 | 20.4973 | 15.2155, 6.28258, 14.4094, 35.8644, 21.779, 16.7825 |  |
| 22H_10M | Householder R12 (fresh) | 0.001 | 8103 | 128 | PASS | 0.847978 | 24.6109 | 19.7346, 6.61042, 17.5037, 41.8211, 26.5655, 20.9742 |  |
| 22H_10M | Householder R12 (fresh) | 0.003 | 8103 | 64 | PASS | 0.65508 | 18.1004 | 15.0611, 6.19169, 14.3746, 29.8515, 20.3271, 13.7709 |  |
| 22H_10M | Householder R12 (fresh) | 0.003 | 8103 | 128 | PASS | 0.767023 | 21.9763 | 17.7923, 6.3449, 15.5083, 36.5209, 24.3456, 19.3373 |  |
| 22H_10M | Householder R4 (cached) | 0.001 | 8101 | 64 | PASS | 0.638782 | 18.1163 | 13.5138, 5.79936, 13.7668, 31.2006, 19.9412, 13.8667 |  |
| 22H_10M | Householder R4 (cached) | 0.001 | 8101 | 128 | PASS | 0.781211 | 22.5204 | 17.428, 6.0464, 15.9061, 36.6996, 25.635, 21.1114 |  |
...
| 22H_10M | Householder R4 (cached) | 0.003 | 8101 | 64 | PASS | 0.682624 | 20.1167 | 14.584, 6.01005, 14.125, 37.8707, 19.6508, 12.626 |  |
| 22H_10M | Householder R4 (cached) | 0.003 | 8101 | 128 | PASS | 0.788774 | 23.5288 | 16.7195, 5.91055, 15.9081, 42.2733, 24.4919, 19.1626 |  |
...
| 22H_10M | Householder R4 (cached) | 0.001 | 8102 | 64 | PASS | 0.683128 | 20.1598 | 14.0725, 5.80592, 15.1423, 37.0281, 19.7678, 14.6838 |  |
| 22H_10M | Householder R4 (cached) | 0.001 | 8102 | 128 | PASS | 0.80271 | 23.9283 | 18.0447, 6.0228, 16.3062, 42.7128, 24.2386, 19.8922 |  |
...
| 22H_10M | Householder R4 (cached) | 0.003 | 8102 | 64 | PASS | 0.687781 | 19.3321 | 15.4578, 6.33377, 14.8917, 34.5952, 21.1172, 9.93933 |  |
| 22H_10M | Householder R4 (cached) | 0.003 | 8102 | 128 | PASS | 0.726599 | 21.2942 | 15.622, 6.09068, 14.6419, 38.7776, 22.2265, 15.08 |  |
...
| 22H_10M | Householder R4 (cached) | 0.001 | 8103 | 64 | PASS | 0.718865 | 20.5754 | 14.5281, 6.11797, 13.3755, 35.8276, 24.3782, 15.3225 |  |
| 22H_10M | Householder R4 (cached) | 0.001 | 8103 | 128 | PASS | 0.82365 | 23.8899 | 17.6837, 6.13861, 15.503, 40.8466, 28.1034, 19.3746 |  |
...
| 22H_10M | Householder R4 (cached) | 0.003 | 8103 | 64 | PASS | 0.720662 | 20.6958 | 15.0182, 6.11466, 14.5409, 34.4964, 23.469, 18.8345 |  |
| 22H_10M | Householder R4 (cached) | 0.003 | 8103 | 128 | PASS | 0.943293 | 28.7973 | 17.586, 6.52458, 16.9612, 44.4795, 30.9185, 37.4406 |  |
...
|---|---|---|
| Householder R12 (fresh) | 0.003 | 0.001: eligible, pooled RMSE 0.753988; 0.003: eligible, pooled RMSE 0.720384 |
| Householder R4 (cached) | 0.001 | 0.001: eligible, pooled RMSE 0.751448; 0.003: eligible, pooled RMSE 0.759592 |
...
|---|---:|---:|---|---|---:|---:|---:|---:|---|---:|
| Householder R12 (fresh) | 0.001 | 8101 | fresh | PASS / PASS | 4096 | 254.964 | 806 | 0 | 3224 / 48 / 0 / 192 | n/a |
| Householder R12 (fresh) | 0.003 | 8101 | fresh | PASS / PASS | 4096 | 265.887 | 806 | 0 | 3224 / 48 / 0 / 192 | 11.0453 |
| Householder R12 (fresh) | 0.001 | 8102 | fresh | PASS / PASS | 4096 | 264.507 | 806 | 0 | 3224 / 48 / 0 / 192 | n/a |
| Householder R12 (fresh) | 0.003 | 8102 | fresh | PASS / PASS | 4096 | 262.761 | 806 | 0 | 3224 / 48 / 0 / 192 | 11.2406 |
| Householder R12 (fresh) | 0.001 | 8103 | fresh | PASS / PASS | 4096 | 263.661 | 806 | 0 | 3224 / 48 / 0 / 192 | n/a |
| Householder R12 (fresh) | 0.003 | 8103 | fresh | PASS / PASS | 4096 | 282.616 | 806 | 0 | 3224 / 48 / 0 / 192 | 11.0781 |
| Householder R4 (cached) | 0.001 | 8101 | cached_parent | PASS / PASS | 4096 | 134.138 | 630 | 0 | 2520 / 48 / 0 / 192 | 6.44908 |
| Bounded dense | 0.001 | 8101 | cached_parent | PASS / PASS | 4096 | 75.7769 | 806 | 0 | 3224 / 48 / 0 / 192 | 3.88371 |
| Unbounded dense | 0.001 | 8101 | cached_parent | PASS / PASS | 4096 | 74.8422 | 806 | 0 | 3224 / 48 / 0 / 192 | n/a |
| Bounded dense + MLP | 0.001 | 8101 | cached_parent | PASS / PASS | 4096 | 60.4154 | 590 | 0 | 2360 / 48 / 0 / 192 | 3.25408 |
| GRU32 residual | 0.001 | 8101 | cached_parent | PASS / PASS | 4096 | 46.519 | 5916 | 0 | 23664 / 200 / 0 / 192 | n/a |
| Householder R4 (cached) | 0.003 | 8101 | cached_parent | PASS / PASS | 4096 | 134.113 | 630 | 0 | 2520 / 48 / 0 / 192 | n/a |
| Bounded dense | 0.003 | 8101 | cached_parent | PASS / PASS | 4096 | 74.754 | 806 | 0 | 3224 / 48 / 0 / 192 | n/a |
| Unbounded dense | 0.003 | 8101 | cached_parent | PASS / PASS | 4096 | 74.2975 | 806 | 0 | 3224 / 48 / 0 / 192 | 3.95248 |
| Bounded dense + MLP | 0.003 | 8101 | cached_parent | PASS / PASS | 4096 | 60.0091 | 590 | 0 | 2360 / 48 / 0 / 192 | n/a |
| GRU32 residual | 0.003 | 8101 | cached_parent | PASS / PASS | 4096 | 45.9832 | 5916 | 0 | 23664 / 200 / 0 / 192 | 1.94042 |
| Householder R4 (cached) | 0.001 | 8102 | cached_parent | PASS / PASS | 4096 | 134.496 | 630 | 0 | 2520 / 48 / 0 / 192 | 6.33606 |
| Bounded dense | 0.001 | 8102 | cached_parent | PASS / PASS | 4096 | 84.4139 | 806 | 0 | 3224 / 48 / 0 / 192 | 4.02817 |
| Unbounded dense | 0.001 | 8102 | cached_parent | PASS / PASS | 4096 | 83.5224 | 806 | 0 | 3224 / 48 / 0 / 192 | n/a |
| Bounded dense + MLP | 0.001 | 8102 | cached_parent | PASS / PASS | 4096 | 66.6671 | 590 | 0 | 2360 / 48 / 0 / 192 | 3.5309 |
| GRU32 residual | 0.001 | 8102 | cached_parent | PASS / PASS | 4096 | 51.2257 | 5916 | 0 | 23664 / 200 / 0 / 192 | n/a |
| Householder R4 (cached) | 0.003 | 8102 | cached_parent | PASS / PASS | 4096 | 138.754 | 630 | 0 | 2520 / 48 / 0 / 192 | n/a |
| Bounded dense | 0.003 | 8102 | cached_parent | PASS / PASS | 4096 | 73.9294 | 806 | 0 | 3224 / 48 / 0 / 192 | n/a |
| Unbounded dense | 0.003 | 8102 | cached_parent | PASS / PASS | 4096 | 73.5114 | 806 | 0 | 3224 / 48 / 0 / 192 | 4.12415 |
| Bounded dense + MLP | 0.003 | 8102 | cached_parent | PASS / PASS | 4096 | 58.6831 | 590 | 0 | 2360 / 48 / 0 / 192 | n/a |
| GRU32 residual | 0.003 | 8102 | cached_parent | PASS / PASS | 4096 | 45.9489 | 5916 | 0 | 23664 / 200 / 0 / 192 | 1.96292 |
| Householder R4 (cached) | 0.001 | 8103 | cached_parent | PASS / PASS | 4096 | 130.447 | 630 | 0 | 2520 / 48 / 0 / 192 | 6.49544 |
| Bounded dense | 0.001 | 8103 | cached_parent | PASS / PASS | 4096 | 73.9122 | 806 | 0 | 3224 / 48 / 0 / 192 | 4.03144 |
| Unbounded dense | 0.001 | 8103 | cached_parent | PASS / PASS | 4096 | 74.3885 | 806 | 0 | 3224 / 48 / 0 / 192 | n/a |
| Bounded dense + MLP | 0.001 | 8103 | cached_parent | PASS / PASS | 4096 | 61.643 | 590 | 0 | 2360 / 48 / 0 / 192 | 3.58983 |
| GRU32 residual | 0.001 | 8103 | cached_parent | PASS / PASS | 4096 | 46.8474 | 5916 | 0 | 23664 / 200 / 0 / 192 | n/a |
| Householder R4 (cached) | 0.003 | 8103 | cached_parent | PASS / PASS | 4096 | 131.916 | 630 | 0 | 2520 / 48 / 0 / 192 | n/a |
| Bounded dense | 0.003 | 8103 | cached_parent | PASS / PASS | 4096 | 76.1951 | 806 | 0 | 3224 / 48 / 0 / 192 | n/a |
| Unbounded dense | 0.003 | 8103 | cached_parent | PASS / PASS | 4096 | 74.778 | 806 | 0 | 3224 / 48 / 0 / 192 | 3.90327 |
| Bounded dense + MLP | 0.003 | 8103 | cached_parent | PASS / PASS | 4096 | 60.2415 | 590 | 0 | 2360 / 48 / 0 / 192 | n/a |
| GRU32 residual | 0.003 | 8103 | cached_parent | PASS / PASS | 4096 | 46.1752 | 5916 | 0 | 23664 / 200 / 0 / 192 | 1.9035 |
| Legacy instant (cached) | 0.001 | 8101 | cached_parent | PASS / PASS | 4096 | 78.4861 | 1014 | 192 | 4056 / 48 / 0 / 192 | 4.05129 |
| Legacy instant (cached) | 0.003 | 8101 | cached_parent | PASS / PASS | 4096 | 77.6411 | 1014 | 192 | 4056 / 48 / 0 / 192 | n/a |
| Legacy instant (cached) | 0.001 | 8102 | cached_parent | PASS / PASS | 4096 | 78.2844 | 1014 | 192 | 4056 / 48 / 0 / 192 | 3.85794 |
| Legacy instant (cached) | 0.003 | 8102 | cached_parent | PASS / PASS | 4096 | 78.5947 | 1014 | 192 | 4056 / 48 / 0 / 192 | n/a |
| Legacy instant (cached) | 0.001 | 8103 | cached_parent | PASS / PASS | 4096 | 77.4723 | 1014 | 192 | 4056 / 48 / 0 / 192 | 3.7035 |
| Legacy instant (cached) | 0.003 | 8103 | cached_parent | PASS / PASS | 4096 | 78.0273 | 1014 | 192 | 4056 / 48 / 0 / 192 | n/a |
| Causal ridge (1) | n/a | None | reference | reference / reference | n/a | n/a | 445440 | 0 | 3563520 / 1536 / 16 / 192 | 0.490833 |
| Causal ridge (100) | n/a | None | reference | reference / reference | n/a | n/a | 445440 | 0 | 3563520 / 1536 / 16 / 192 | 0.509313 |
| Frozen linear AR2 | n/a | None | reference | reference / reference | n/a | n/a | 150 | 0 | 1200 / 144 / 0 / 192 | 0.25077 |
| Persistence | n/a | None | reference | reference / reference | n/a | n/a | 0 | 0 | 0 / 48 / 0 / 192 | 0.0096669 |
...
## All69 registered conditions

| Condition | Passed |
|---|---|
| all_selected_families_and_causal_ridge_eligible | True |
| recording_2021_12_15_21H_54M.mat/mean_5pct/householder | False |
| recording_2021_12_15_21H_54M.mat/seed8101_no_harm/householder | True |
| recording_2021_12_15_21H_54M.mat/seed8102_no_harm/householder | True |
| recording_2021_12_15_21H_54M.mat/seed8103_no_harm/householder | True |
...
| recording_2021_12_15_21H_54M.mat/seed8103_within_5pct/dense_bounded | True |
| recording_2021_12_15_21H_54M.mat/mean_within_2pct/dense_unbounded | False |
| recording_2021_12_15_21H_54M.mat/seed8101_within_5pct/dense_unbounded | True |
...
| recording_2021_12_15_21H_54M.mat/seed8103_within_5pct/dense_mlp | True |
| recording_2021_12_15_21H_54M.mat/mean_within_2pct/gru32 | True |
| recording_2021_12_15_21H_54M.mat/seed8101_within_5pct/gru32 | True |
...
| recording_2021_12_15_21H_54M.mat/seed8103_within_5pct/legacy_instant | True |
...
| recording_2021_12_15_22H_10M.mat/mean_5pct/householder | False |
| recording_2021_12_15_22H_10M.mat/seed8101_no_harm/householder | True |
| recording_2021_12_15_22H_10M.mat/seed8102_no_harm/householder | True |
| recording_2021_12_15_22H_10M.mat/seed8103_no_harm/householder | True |
| recording_2021_12_15_22H_10M.mat/mean_within_2pct/dense_bounded | False |
| recording_2021_12_15_22H_10M.mat/seed8101_within_5pct/dense_bounded | True |
...
| recording_2021_12_15_22H_10M.mat/seed8101_within_5pct/dense_unbounded | True |
...
| recording_2021_12_15_22H_10M.mat/seed8103_within_5pct/gru32 | True |
...
| at_most_105pct_dense_bounded_latency | False |
| at_most_105pct_dense_mlp_latency | False |
