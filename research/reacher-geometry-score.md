...
The [memory comparison](reacher-geometry-memory.md) has completed all 51 comparisons and its independent audit is running. No scientific result is claimed yet. The [prospective design](../output/reacher-geometry-score-v1/next-experiment-design.md) records the rationale. Ranking-head training waits for this comparison. A biological claim would require a specific new mechanism and conventional history controls; the present result supplies neither.
