...
The [memory comparison](reacher-geometry-memory.md) is now frozen and its execution has started. The [prospective design](../output/reacher-geometry-score-v1/next-experiment-design.md) records the rationale. Ranking-head training waits for this comparison. A biological claim would require a specific new mechanism and conventional history controls; the present result supplies neither.
