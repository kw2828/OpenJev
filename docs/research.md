...
| Recurrent world model | Original GRU scaffold plus trained `PredictiveMemory`: recurrent PPO and action-conditioned 1/2/4-step prediction, reward/termination controls and reset diagnostics | [12-fit MiniGrid study](recurrent-world-model-study.md) failed its continuation gate; useful information acquisition, planning and independent transfer remain unestablished. Not Dreamer or an RSSM reproduction |
